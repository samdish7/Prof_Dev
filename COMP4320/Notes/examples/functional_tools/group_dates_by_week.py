...
# number of days per month, for generating random dates
date_details = [(1, 31), (2, 28), (3, 31), (4, 30), (5, 31), (6, 30), (7, 31),
    ...
    for month, days in date_details:
        for i in range(1, days + 1):
            for _ in range(randint(1, 3)):
                ...
                dates.append(date)
    # print(dates)  # uncomment to see raw date list
    return dates
...
def display_groups(dates):
    ...
    DATE.isocalendar() returns ISO year, ISO week number, ISO weekday tuple.
